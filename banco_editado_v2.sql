...
CREATE TABLE veiculo_vaga(
	idVeiculo_vaga INT auto_increment NOT NULL,
    fkVeiculo INT NOT NULL,
    fkVaga INT NOT NULL,
...
ALTER TABLE veiculo MODIFY placa VARCHAR(8);
...
INSERT INTO cliente (idCliente, nomeCliente, email) VALUES
(41, 'Eduarda Ferreira', 'Eduarda@email.com');

INSERT INTO veiculo (idVeiculo, placa, tipo) VALUES
(59, 'EFX9D55', 'moto');

INSERT INTO cliente_veiculo (fkCliente, fkVeiculo) VALUES
(41, 59);

INSERT INTO veiculo_vaga (idVeiculo_vaga, fkVeiculo, fkVaga, data_hora_entrada, data_hora_saida) VALUES
(85, 59, 5, '2025-05-19 18:00:00', '2025-05-19 21:00:00');

UPDATE cliente
SET email = 'empresa@empresa.com'
WHERE nomeCliente = 'Bruna Freitas' and 'Igor Aragão' and 'Pietra Lima';

SELECT fkVeiculo, data_hora_entrada 
FROM veiculo_vaga;